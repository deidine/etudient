...
<div class="h"><fieldset><legend style="color:black;">
       ...
       $sql4="SELECT * FROM departement ";
      $res4=mysqli_query($con,$sql4);
       $row4=mysqli_num_rows($res4);
        ?> <ol class="l"><?php echo "<li>il y'a $row4 departement dans l'universite</li>";?></ol>
