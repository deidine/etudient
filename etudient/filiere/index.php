...
<html>
 ...
 <title>maison</title></head>
   ...
   bien venu ici vous avez trouvee les filiere 
   </h3>
</j>


    <a href="../home.php"><button style="color:black;margin-top:70px;"><img src="../log/back.gif">RETOUR</button></a>
<h1> filiere du universiteè </h1>
<div class="h"><fieldset><legend style="color:black;">
        ...
        <a href="afficher.php"><button class="af_voit"></button></a></td></tr>
         </div> 
        </table></fieldset>
       ...
       $sql4="SELECT * FROM filliere";
      $res4=mysqli_query($con,$sql4);
       $row4=mysqli_num_rows($res4);
        ?> <ol class="l"><?php echo "<li>il y'a $row4 filliere dans l'universite</li>";?></ol>
